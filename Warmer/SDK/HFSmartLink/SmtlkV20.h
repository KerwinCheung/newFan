...
-(void)smtlkV20Event:(BOOL)success APPwd:(NSString *)apPwd auth:(NSString *)auth encry:(NSString *)encry;
-(void)smtlkV20Event:(BOOL)success wifimode:(NSString *)wifimode ssid:(NSString *)ssid channel:(NSString *)channel;
@end
